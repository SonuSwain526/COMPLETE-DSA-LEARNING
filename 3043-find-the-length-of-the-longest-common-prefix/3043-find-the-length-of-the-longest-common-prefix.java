...
//                 if(strArr2[i].charAt(0) != strArr1[j].charAt(0)) continue;
//                 if(strArr2[i].equals(strArr1[j])){
//                     curLen = Math.max(curLen, strArr2[i].length());
//                 }else {
//                     int len = 0;
//                     for (int k = 0; k < Math.min(strArr1[j].length(), strArr2[i].length()); k++) {
//                        if(strArr2[i].charAt(k) == strArr1[j].charAt(k)){
//                            len++;
//                        }else break;
//                     }
